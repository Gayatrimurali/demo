...
Introduzca Units = SUM(Sales[Quantity]) en la barra de fórmulas. 

Haga clic en la marca de verificación izquierda de la barra de fórmulas o haga clic en el botón Enter. 

En el panel Propiedades a la derecha, expanda la sección Formato (el panel Propiedades puede tardar unos momentos en cargarse). 

En el menú desplegable Formato, seleccione Número entero. 

Establezca el Separador de miles en Sí. 
