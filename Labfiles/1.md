...
Se abre el cuadro de diálogo Nueva relación. Asegúrese de que la Table 1 sea PO y que la Columna sea Order_Date. 

Asegúrese de que la Table 2 sea Date y que la Columna sea Date. 

Asegúrese de que la Cardinality sea Varios a uno (*:1). 

Asegúrese de que la Dirección de filtro cruzado sea Único. 
